...
Color themeColor = const Color(0xFF0057FF);
...
Color vehicalThemColor = const Color(0xFF0057FF);
...
Color acentColor  =const Color(0xFF0057FF);
...
class ColorNotifires with ChangeNotifier {
  ...
  get getHighlightColor=>isDark?Colors.grey.shade600:Colors.grey.shade100;
    get getAppBarcolor =>
      isDark ? darkmode : lightBackColor.withOpacity(0.7);

  get getGrey1Whitecolor=>isDark?whiteColor:grey1;  //background color
  get getGrey2Whitecolor=>isDark?whiteColor:grey2;  //background color
  get getGrey3Whitecolor=>isDark?whiteColor:grey3;  //background color
  get getGrey4Whitecolor=>isDark?whiteColor:grey4;  //background color
  get getGrey5Whitecolor=>isDark?whiteColor:grey5;  //background color
  get getGrey6Whitecolor=>isDark?whiteColor:grey6;  //background color
  get getBoxColor=>isDark?grey2:whiteColor;  //background color
}
