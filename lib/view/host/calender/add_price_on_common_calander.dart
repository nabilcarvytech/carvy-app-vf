...
class AddPriceOnCommonCalander extends StatefulWidget {
  final List<PickerDateRange> selectedDates;
  final List selectedAvailableRange;
  final VoidCallback onPressed; //

  const AddPriceOnCommonCalander({
    super.key,
  ...
  @override
  State<AddPriceOnCommonCalander> createState() =>
      _AddPriceOnCommonCalanderState();
}

class _AddPriceOnCommonCalanderState extends State<AddPriceOnCommonCalander> {
