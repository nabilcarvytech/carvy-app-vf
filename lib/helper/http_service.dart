...
Future<dynamic> httpPost(path, data) async {
  ...
  if (path == Config.cancelBookingByUser) {
    ...
    developer
        .log("⚠️ MOCK MODE: Returning mock cancel-booking-by-user response");
    return mockResponse;
  }
  // ========== END MOCK DATA ==========
  ...
  // ========== MOCK DATA - get-vendor-dashboard-record API ==========
  // TODO: REMOVE THIS MOCK AFTER NODE.JS BACKEND IMPLEMENTATION
  if (path == Config.hostDashBoard) {
    await Future.delayed(const Duration(seconds: 1));
    ...
    developer.log("⚠️ MOCK MODE: Returning mock get-vendor-dashboard-record");
    return mockResponse;
  }
  // ========== END MOCK DATA ==========
  ...
  // ========== MOCK DATA - my-items API ==========
  // TODO: REMOVE THIS MOCK AFTER NODE.JS BACKEND IMPLEMENTATION
  if (path == Config.myItems) {
    await Future.delayed(const Duration(seconds: 1));

    // Simule la liste des véhicules du host (My Items).
    Map<String, dynamic> mockResponse = {
      "status": 200,
      ...
      "data": {
        "host_status": "1",
        "checkLimit": 10,
        "offset": (int.tryParse(data["offset"]?.toString() ?? "0") ?? 0) + 2,
        "limit": "10",
        "items": [
          {
            "id": 101,
            ...
            "description":
                "Clean and comfortable sedan perfect for city driving",
            "item_rating": "4.5",
            "mobile": "+1234567890",
            "status": "1",
            "person_allowed": "5",
            ...
            "front_image": {
              ...
              "original_url":
                  "https://example.com/host-camry-front-original.jpg",
            ...
            "gallery": [
              {
                ...
                "thumbnail":
                    "https://example.com/host-camry-gallery-1-thumb.jpg",
                "preview":
                    "https://example.com/host-camry-gallery-1-preview.jpg",
                "original_url":
                    "https://example.com/host-camry-gallery-1-original.jpg",
                "preview_url":
                    "https://example.com/host-camry-gallery-1-preview.jpg"
              }
            ],
            ...
            "booked_dates": null,
            "item_info":
                "{\"host_id\":\"1\",\"service_type\":\"booking\",\"review_data\":[],\"features_data\":[],\"gallery_image_urls\":[]}",
            "metaData": "{}"
          },
          {
            "id": 102,
            ...
            "front_image": {
              ...
              "original_url":
                  "https://example.com/host-tesla-front-original.jpg",
            ...
            "gallery": [
              {
                ...
                "thumbnail":
                    "https://example.com/host-tesla-gallery-1-thumb.jpg",
                "preview":
                    "https://example.com/host-tesla-gallery-1-preview.jpg",
                "original_url":
                    "https://example.com/host-tesla-gallery-1-original.jpg",
                "preview_url":
                    "https://example.com/host-tesla-gallery-1-preview.jpg"
              }
            ],
    ...
    developer.log(
        "⚠️ MOCK MODE: Returning mock my-items list for offset: ${data['offset']}");
    return mockResponse;
  }
  // ========== END MOCK DATA ==========
