...
class User {
  ...
  dynamic _resetToken;
  dynamic _verified;
  dynamic _phoneVerify;
  dynamic _emailVerify;
  dynamic _loginType;
  dynamic _birthdate;
  dynamic _socialId;
  dynamic _status;
  ...
  dynamic get otpValue => _otpValue;
  dynamic get token => _token;
  dynamic get resetToken => _resetToken;
  dynamic get verified => _verified;
  dynamic get phoneVerify => _phoneVerify;
  dynamic get emailVerify => _emailVerify;
...
class Media {
  ...
  num? get orderColumn => _orderColumn;
