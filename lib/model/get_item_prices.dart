...
class GetItemPrices {
  ...
  GetItemPrices.fromJson(dynamic json) {
    _status = json['status'];
  ...
  Data? _data;
  String? _error;
GetItemPrices copyWith({  num? status,
  String? message,
  Data? data,
  String? error,
}) => GetItemPrices(  status: status ?? _status,
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _pricePerNight = json['price_per_day'];
    _totalNights = json['total_days'];
...
Data copyWith({  
  ...
  Map<String, dynamic> toJson() {
    ...
    map['price_per_day'] = _pricePerNight;
    map['total_days'] = _totalNights;
